classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Virtual-Measurement-of-the-Electron-Charge-To-Mass-Ratio-Lab";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Virtual Measurement of the Electron to Mass ratio ';
            ...
            app.Image.Position = [33 141 213 186];
            app.Image.ImageSource = 'apparatus.png';
